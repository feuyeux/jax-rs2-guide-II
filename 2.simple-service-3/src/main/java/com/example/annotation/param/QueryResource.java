...
public class QueryResource {
  ...
  public Yijings getByPaging(
      @QueryParam("start") final int start, @QueryParam("size") final int size) {
  ...
  @GET
  @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
  public Yijings getByOrder(
      @QueryParam("limit") final int limit, @QueryParam("sort") final String sortName) {
    final Yijings result = new Yijings();
    final List<Link> links = new ArrayList<>();
    final List<Yijing> yijings = new ArrayList<>();

...
public class PathResource {
  ...
  public String getByCondition(
      @PathParam("from") final Integer from, @PathParam("to") final Integer to) {
  ...
  @Produces(MediaType.TEXT_PLAIN)
  public String getByCondition2(
      @PathParam("beginMonth") final String m1,
      @PathParam("beginYear") final Integer y1,

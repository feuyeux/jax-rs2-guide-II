...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
  ...
  public ContentNegotiatingViewResolver contentViewResolver() throws Exception {
    ...
    contentViewResolver.setDefaultViews(
        Collections.<View>singletonList(new MappingJackson2JsonView()));
  ...
  @Bean
  public ClientController tarotController(
      @Qualifier("tarotRestTemplate") RestOperations restTemplate) {

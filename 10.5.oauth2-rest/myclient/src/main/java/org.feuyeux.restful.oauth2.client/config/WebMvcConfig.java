...
import org.feuyeux.restful.oauth2.client.mvc.ConferenceController;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    protected static class ResourceConfiguration {
        ...
        public OAuth2ProtectedResourceDetails conferenceRedirect() {
            AuthorizationCodeResourceDetails details = new AuthorizationCodeResourceDetails();
            details.setId("myserver/client-redirect");
        ...
        public OAuth2ProtectedResourceDetails trusted() {
            ...
            details.setId("myserver/trusted");

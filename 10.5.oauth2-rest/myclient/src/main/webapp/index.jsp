...
<body>
<div class="container">
    <h1>OAuth2 Client Web Site</h1>

    <p>
        <a href="<c:url value="/myserver/tarots"/>">查看塔罗牌</a><br/>
        <a href="<c:url value="/myserver/speakers"/>">View speakers</a><br/>
        <a href="<c:url value="/myserver/sessions"/>">View sessions</a>
    </p>
</div>

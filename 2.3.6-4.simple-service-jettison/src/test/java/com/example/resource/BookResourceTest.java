...
public class BookResourceTest extends JerseyTest {
  ...
  public void testJsonBook() {
    JsonBook book =
        target("books").path("jsonbook").request(MediaType.APPLICATION_JSON).get(JsonBook.class);
  ...
  public void testJsonBook2() {
    JsonBook2 book =
        target("books").path("jsonbook2").request(MediaType.APPLICATION_JSON).get(JsonBook2.class);
  ...
  public void testPost() {
    Entity<Book> e =
        Entity.entity(
            new Book(4L, "Java Restful Web Services实战II", "机械工业出版社"),
